-- Ensure approved listings copy whatsapp_number from pending_businesses -> businesses
-- This fixes end-to-end WhatsApp visibility on public listing + booking modal.
