...
export const translations: Record<string, Record<Language, string>> = {
  ...
  'checkout.how_it_works_compact': {
    en: 'Pick who is covered (ages 6+), choose a single day or whole-trip coverage, then your start date. Under-6 children travel free with your group.',
    fr: 'Choisissez qui est couvert (6 ans +), un jour ou tout le séjour, puis la date de début. Les moins de 6 ans voyagent gratuitement.',
    bi: 'Jusum hu i kava (6+), wan dei o ful trip, mo det blong stat. Pikinini under 6 i fri wetem grup.',
  },
