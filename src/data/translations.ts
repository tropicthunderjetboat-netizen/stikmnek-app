...
export const translations: Record<string, Record<Language, string>> = {
  ...
  'checkout.option_extended_title': { en: '14-day pass (+A$10)', fr: 'Pass 14 jours (+10 $ AUD)', bi: 'Pas 14 dei (+A$10)' },
  'checkout.option_extended_desc': {
    en: '14 calendar days of discounts — best if you are staying several nights.',
    fr: '14 jours calendaires de réductions — idéal pour un séjour de plusieurs nuits.',
    bi: '14 kalenda dei blong diskount — bes taem yu stap plande naet.',
  },
  ...
  'checkout.how_it_works_compact': {
    en: 'Pick who is covered (ages 6+), choose 1-day or 14-day coverage, then your start date. Under-6 children travel free with your group.',
    fr: 'Choisissez qui est couvert (6 ans +), 1 jour ou 14 jours, puis la date de début. Les moins de 6 ans voyagent gratuitement.',
    bi: 'Jusum hu i kava (6+), wan dei o 14 dei, mo det blong stat. Pikinini under 6 i fri wetem grup.',
  },
