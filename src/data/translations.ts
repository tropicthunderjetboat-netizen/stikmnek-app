...
export const translations: Record<string, Record<Language, string>> = {
  ...
  // Hero
  'hero.title': { en: 'Discover Vanuatu\'s Best Deals', fr: 'Découvrez les meilleures offres du Vanuatu', bi: 'Faenem Bes Dils blong Vanuatu' },
  'hero.subtitle': {
  ...
  'hero.ctaTourist': { en: 'Sign Up & Get Deals', fr: 'Inscrivez-vous et profitez des offres', bi: 'Saen Ap mo Karem Dils' },
  'hero.ctaBusiness': { en: 'List Your Business (Free)', fr: 'Inscrivez votre entreprise (gratuit)', bi: 'List blong Bisnis Blong Yu (Fri)' },
  ...
  'hero.explore': { en: 'Explore Deals', fr: 'Explorer les offres', bi: 'Eksploarem lo Dils' },
  'hero.browseDeals': { en: 'Browse deals', fr: 'Voir les offres', bi: 'Lukim ol dils' },
  'hero.welcomeBack': { en: 'Welcome back — find your next deal', fr: 'Bon retour — trouvez votre prochaine offre', bi: 'Welkam bak — faenem nex dils blong yu' },
  'hero.businesses': { en: 'Local Businesses', fr: 'Entreprises locales', bi: 'Lokol Bisnis' },
  'hero.savings': { en: 'Average Savings', fr: 'Économies moyennes', bi: 'Averej Sevings' },
  ...
  'cat.spa': { en: 'Spa & Wellness', fr: 'Spa & Bien-être', bi: 'Spa mo Helt' },
  'cat.accommodation': { en: 'Accommodation', fr: 'Hébergement', bi: 'Ples blong slip' },
  
  // Passes
  'pass.title': { en: 'Build your Pass', fr: 'Construisez votre pass', bi: 'Mekem Pas blo yu' },
  'pass.subtitle': {
    en: 'Customize your adventure with flexible pricing',
    fr: 'Personnalisez votre aventure avec une tarification flexible',
    bi: 'mekem gud  travel blong yu wetem ol fleksibol praeses',
  },
  ...
  'pass.build_how_desc': {
    ...
    bi: 'Sign ap, putum hu mas travelem, tet blong trip, pem wetem kredit kad, mo statem seving.',
  },
  ...
  'passPricing.card_1d_hint': { en: '24h access', fr: 'Accès 24 h', bi: '24 aoa akses' },
  ...
  'passPricing.badge_best_value': { en: 'Best value', fr: 'Meilleur rapport', bi: 'Bes valiu' },
  'passPricing.chip_35': { en: '35% off', fr: '-35 %', bi: 'karemaot 35% ' },
  ...
  'passPricing.chip_row_map': { en: 'Live Map', fr: 'Carte live', bi: 'laev Map' },
  ...
  'passPricing.people_label': {
    ...
    bi: 'ol bikinini weh (ages 6 yia  iko antap)',
  },
  'passPricing.coverage_label': { en: 'Coverage', fr: 'Couverture', bi: 'Kavarej' },
  'passPricing.max_per_pass': {
    en: 'Max __N__ per pass',
    fr: 'Max __N__ par pass',
    bi: 'Max __N__ wan  pas',
  },
  ...
  'passPricing.savings_anchor': {
    ...
    bi: 'Wetem __COUNT__ man i  save sevem  A$__SAVEM__ long fes dei  blong u nomo!',
  },
  'passPricing.holiday_headline': {
    en: 'Buy 1 week, get 1 week FREE',
    fr: 'Achetez 1 semaine, la 2e semaine est GRATUITE',
    bi: 'pem wan wik, karem narafala wik fri',
  },
  'passPricing.holiday_sub': {
    ...
    bi: ' 7 dei holiday blong  yu + serem app afta bai pem blong anlokem wik 2 blong dils.',
  },
  ...
  'passPricing.included_map': {
    ...
    bi: 'laev Map + saving tracker blong u',
  },
  'passPricing.included_qr': {
    en: 'Instant QR redemption',
    fr: 'Utilisation QR instantanée',
    bi: 'QR i redim stret weh',
  },
  'passPricing.purchase': { en: 'Purchase pass', fr: 'Acheter le pass', bi: 'Pemm pas' },
  ...
  'passPricing.coverage_helper_7d': {
    ...
    bi: 'Signature pas blong long taem stay — bes valiu.',
  },
  'passPricing.coverage_nudge_7d': {
    ...
    bi: 'Stap wan wik o moa? Jusum 7 dei — wik 2 i fri.',
  },
  ...
  'checkout.extra_guests_2_6_row': {
    ...
    bi: 'Ol man 2–6 (__COUNT__ × A$__FEE__)',
  },
  ...
  'checkout.potential_savings': {
    ...
    bi: '💰 Saving we i save: kasem A$__AMOUNT__+ long kakae mo tua — pas ia u pem blong yu wan.',
  },
  'checkout.savings_before_one': {
    en: 'With 1 person, you could save over ',
    fr: 'Avec 1 personne, vous pourriez économiser plus de ',
    bi: 'Wetem wan man, yu save sevem ova',
  },
  'checkout.savings_before_many': {
    ...
    bi: 'Wetem __COUNT__ man, yu save sevem ',
  },
  ...
  'checkout.savings_subline': {
    ...
    bi: 'Long kaen pas ia emi pem em wan ariap nmo!',
  },
  'checkout.profile_party_title': { en: 'From your registration', fr: 'D’après votre inscription', bi: 'Long rejistresen blong yu' },
  ...
  'checkout.option_day_desc': {
    ...
    bi: 'Sot visit — diskount long wan kalenda dei yu jusum.',
  },
  ...
  'checkout.option_extended_desc': {
    ...
    bi: 'I kafaremap visit we i longfala — __CAL__ kalenda dei blong akses long ol dils long det blong stat.',
  },
  'checkout.option_extended_badge': {
    ...
    bi: 'Rekomendem blong __NIGHTS__ naet weh yu stap',
  },
  ...
  'checkout.party_edit': { en: 'Edit', fr: 'Modifier', bi: 'jensem' },
  ...
  'checkout.plan_day_title': { en: '24-Hour Day Pass', fr: 'Pass 24 heures', bi: 'Pas blong 24 Awa' },
  'checkout.plan_day_sub': {
    en: 'Great for cruise ships and short stops.',
    fr: 'Idéal pour les croisières et les escales courtes.',
    bi: 'Bes blong kruz sip mo ol sot stops.',
  },
  'checkout.plan_holiday_title': { en: '7-Day Holiday Pass', fr: 'Pass vacances 7 jours', bi: 'Pas blong 7 dei holidei' },
  'checkout.plan_holiday_sub': {
    ...
    bi: 'Bes stay over blong yu(visita) — 7 kalenda dei akses (+A$15). Serem app afta bai blong 7 dei moa blong free (14 dei long total).',
  },
  'checkout.share_second_week_unlock': {
    ...
    bi: 'Serem ap ia mo gat extra 7 dei frii!',
  },
  ...
  'share.holiday_banner_days_n': {
    ...
    bi: 'Sherem ap ia mo save karem __N__ extra frii dei!',
  },
  'share.holiday_banner_combo': {
    ...
    bi: 'Serem ap ia — +__PEOPLE__ol i man fri mo 7 extra dei moa weh i  FRII!!',
  },
  'share.holiday_banner_people_only': {
    ...
    bi: 'Serem ap mo anlokem +__PEOPLE__ narafala man tu i fri!',
  },
  ...
  'share.holiday_card_subtext': {
    ...
    bi: 'Anlokem bonus wik! Serem wetem ol frens blong kasem 7 dei frii Holiday Pas blong yu.',
  },
  'share.holiday_cta_header_sub': {
    ...
    bi: 'Holidei pas 7+7 — serem ap blong u save kasem 7 extra dei frii',
  },
  'share.holiday_navigator_body': {
    en: 'Share this app and get 7 extra days FREE!!',
    fr: 'Partagez l’application et obtenez 7 jours supplémentaires GRATUITS !!',
    bi: 'Serem  ap ia mo kasem extra 7 dei moa i FREE!!',
  },
  'share.qr_holiday_prompt': {
    ...
    bi: 'Yu gat 7 dei blong dils — serem ap ia blong save gat 7 extra dei FREE long Holiday Pas!',
  },
  'share.dashboard_unlock_button': {
    en: 'Share app — 7 extra days FREE',
    fr: 'Partager l’app — 7 jours gratuits',
    bi: 'Serem ap — yu save gat 7 moa dei  free',
  },
  ...
  'checkout.savings_anchor_v2': {
    ...
    bi: 'Wetem __COUNT__ man, bae yu save moa long kost blong olgeta pas (A$__PASS__) long fes kakae o tua!',
  },
  ...
  'checkout.period_badge_extended_generic': {
    ...
    bi: 'Kavaremap ful trip blong yu',
  },
  ...
  'checkout.end_date_helper_short': {
    ...
    bi: 'Sem kalenda dei — diskount long det blong stat.',
  },
  'checkout.end_date_helper_extended': {
    ...
    bi: 'Kasem det blong finis (i kaont). Akses long dils i last __CAL__  stat long kalenda dei.',
  },
  'checkout.section_pass_group': { en: 'Pass & group', fr: 'Pass et groupe', bi: 'Pas mo grup' },
  'checkout.section_dates': { en: 'When discounts apply', fr: 'Quand les réductions s’appliquent', bi: 'Taem diskount i aplae' },
  ...
  'checkout.window_trip_hint': {
    ...
    bi: 'Trip blong yu emi __NIGHTS__ naet — josem det blong stat wetem taem yu laik yusum dils.',
  },
  ...
  'pass.buy': { en: 'Buy Now', fr: 'Acheter', bi: 'Pem Nao ya' },
  ...
  'pass.know_before_title': { en: 'Know before you buy', fr: 'À savoir avant d’acheter', bi: 'Save bifo yu pem' },
  'pass.know_trip_line': {
    ...
    bi: 'Long profil blong yu: {dei} dei · {party} man long pas (bigman mo pikinini nomo; bebi i no kaont).',
  },
  'pass.know_bullet_1': {
    ...
    bi: ' serem Bonus — i adem moa pipol mo/or moa dei diskount afta yu bai (serem app).',
  },
  'pass.know_bullet_2': {
    ...
    bi: 'Evri kaed i soem base limit blong hem — komperem wetem length blong trip mo grup.',
  },
  'pass.know_bullet_3': {
    ...
    bi: 'Afta pem, yusum Sea app long skrin  blong applaem pas blong bonus.',
  },
  'pass.know_bullet_4': {
  ...
  'pass.know_support': {
    ...
    bi: 'Long bigfala grup o long taem stap, wan pas bae i no save inaf — askem support o tingbaot moa pas.',
  },
  'passFlow.checkout_preview': {
    ...
    bi: 'Checkout: {party} man (6+) · {duration} — A$15 fes, mo A$10 long evri narafala man kasem 20; +A$15 ful trip (yu save jensem bifo pem).',
  },
  ...
  'passFlow.home_skip_desc': {
    ...
    bi: 'Go long sef checkout. Grup mo taem  blong usum profael blong yu — yu save jensem ani taem bifo yu pem',
  },
  ...
  'dash.favorites': { en: 'Favorites', fr: 'Favoris', bi: 'Feverets' },
  ...
  'dash.favorites_list_empty': {
    ...
    bi: 'Lukluk long ol diskaon mo tap long hat blong sevem long ples ia.',
  },
  ...
  'dash.history': { en: 'Redemption History', fr: 'Historique d\'utilisation', bi: 'Histri blong Yusum' },
  ...
  'dash.pass_prefs_sub': {
    ...
    bi: 'Yu sevem taem yu openem checkout (yu save jensem befo yu pem).',
  },
  ...
  'passPrefs.group_hint_none': {
    ...
    bi: 'No gat difolt — checkout i yusum grup blong travel o 1 gest.',
  },
  ...
  'passPrefs.just_me': { en: 'Just me (clear saved size)', fr: 'Moi seul (effacer la taille)', bi: 'Mi wan (klearem saes)' },
  'passPrefs.people_n': { en: '{n} people', fr: '{n} personnes', bi: '{n} pipol' },
  'passPrefs.duration_label': { en: 'Preferred pass length', fr: 'Durée du pass préférée', bi: 'Stret taem blong pas' },
  ...
  'passPrefs.saving': { en: 'Saving…', fr: 'Enregistrement…', bi: 'Sev ap…' },
  'passPrefs.saved': { en: 'Preferences saved', fr: 'Préférences enregistrées', bi: 'Preference ino sev' },
  'passPrefs.save_failed': { en: 'Could not save preferences', fr: 'Impossible d’enregistrer', bi: 'preference ino sev' },
  ...
  'passPrefs.post_desc': {
    ...
    bi: 'Sevem grup mo taem blong pas yu pem olsem difolt blong nekis taem.',
  },
  'passPrefs.post_remember': { en: 'Save as my defaults', fr: 'Enregistrer comme défauts', bi: 'Sevem olsem difolt blong mi' },
  'passPrefs.post_save': { en: 'Save', fr: 'Enregistrer', bi: 'Sevem' },
  'passPrefs.post_skip': { en: 'Not now', fr: 'Pas maintenant', bi: 'No naoia' },
  
  // Footer
  'footer.about': { en: 'About StikmNek', fr: 'À propos de StikmNek', bi: 'Abaotem StikmNek' },
  'footer.abouttext': { en: 'StikmNek connects tourists with the best local businesses across Vanuatu. Save money while experiencing authentic island culture.', fr: 'StikmNek connecte les touristes avec les meilleures entreprises locales à travers le Vanuatu. Économisez tout en vivant la culture insulaire authentique.', bi: 'StikmNek i konetim turis wetem bes lokal bisnis long Vanuatu. Sevem mani taem yu eksperiens tru aelan kalja.' },
  ...
  'footer.nameMeaningBody': {
    ...
    bi: 'Hemia Bislama slang: yu go klosap wetem konfiden mo smael blong mekem man i gat intres — frendli persuesen blong Vanuatu.',
  },
  ...
  'footer.business': { en: 'List Your Business', fr: 'Inscrivez votre entreprise', bi: 'Listim ol Bisnis Blong Yu' },
  ...
  'general.cancel': { en: 'Cancel', fr: 'Annuler', bi: 'Kanselem' },
