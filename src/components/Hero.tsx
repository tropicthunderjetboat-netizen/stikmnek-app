...
const Hero: React.FC = () => {
  ...
  const browseCta = t('hero.browseSpots', language).replace('__COUNT__', String(businessCount || 63));
  const footerMeta = t('hero.footerMeta', language).replace('__COUNT__', String(businessCount || 63));
    ...
    >
      ...
      >
        <div className="max-w-2xl">
          ...
          <div className={`flex flex-col gap-3 w-full max-w-md ${signedInTourist ? 'mb-6' : 'mb-10'}`}>
            {user?.type === 'business' ? (
              <>
                <button
                  type="button"
                ...
                >
                  ...
                  {language === 'en' ? 'Go to my dashboard' : 'Aller à mon tableau de bord'}
                </button>
                <button
                  type="button"
